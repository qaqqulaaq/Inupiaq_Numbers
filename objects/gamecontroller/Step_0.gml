...
else if keyboard_check_pressed(vk_f1) or (position_meeting(mouse_x,mouse_y,helpbutton) and mouse_check_button_pressed(mb_left))  help();
...
else if (keyboard_check_pressed(ord("1")) or (position_meeting(mouse_x,mouse_y,choice1) and mouse_check_button_released(mb_left))) and room == vocab_multichoice with choice1 choosebox();
else if (keyboard_check_pressed(ord("2")) or (position_meeting(mouse_x,mouse_y,choice2) and mouse_check_button_released(mb_left))) and room == vocab_multichoice with choice2 choosebox();
else if (keyboard_check_pressed(ord("3")) or (position_meeting(mouse_x,mouse_y,choice3) and mouse_check_button_released(mb_left))) and room == vocab_multichoice with choice3 choosebox();
else if (keyboard_check_pressed(ord("4")) or (position_meeting(mouse_x,mouse_y,choice4) and mouse_check_button_released(mb_left))) and room == vocab_multichoice with choice4 choosebox();
